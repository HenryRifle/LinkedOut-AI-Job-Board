...
#GAURANGI - modifying importing files such that it is compatible with both mac and windows.

#index_sheet = pd.read_excel("project_data\\2019-29\\occupation.xlsx")

occupation_file = Path("project_data") / "2019-29" / "occupation.xlsx"
index_sheet = pd.read_excel(occupation_file)

...
occupation_23_to_33_file = Path("project_data") / "2023-33" / "occupation.xlsx" #GAURANGI
occupation_19_29_file = Path("project_data") / "2019-29" / "occupation.xlsx" #GAURANGI
industry_23_to_33_file = Path("project_data") / "2023-33" / "industry.xlsx" #GAURANGI

#Importing the datasets
occupations_df_23 = pd.read_excel(occupation_23_to_33_file, sheet_name = 2, header = 1) #GAURANGI
occupations_df_19 = pd.read_excel(occupation_19_29_file, sheet_name=2, header = 1) #GAURANGI
...
education_df = pd.read_excel(occupation_23_to_33_file, sheet_name = 3, header = 1) #GAURANGI
education_df.rename({'2023 National Employment Matrix title':'Occupation'})


industry_df = pd.read_excel(industry_23_to_33_file, sheet_name=11, header=1)
